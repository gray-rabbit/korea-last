<script lang="ts">
	...
	const datas = ['가', '나', '다', '라', '마', 'ㄷ', '갇', '낟', '닫', '랃', '맏'];
	const datas2 = ['버', '서', '저', '터', '퍼', 'ㄷ', '벋', '섣', '젇', '턷', '펃'];
...
<div class="pt-4 px-4">
	...
	<div class="border-2 rounded-lg p-2 border-gray-400">
		<p class="text-2xl">
			ㄷ(디<Textimpact classstring="text-blue-500">읃</Textimpact>)받침에서 <Textimpact
				classstring="text-blue-500">/읃/</Textimpact
			> 소리가 나요.
		</p>
	</div>
	<br />
	<p class="text-3xl">'ㄷ'의 소리를 눌러서 확인하세요.</p>
	<div class="border-2 rounded-lg flex w-full justify-center py-5">
		<div class="flex justify-center items-center min-w-[100px] bg-blue-100 rounded-xl">
			<button
				...
				on:click={play_element_value_by_slow}>ㄷ</button
			>
		</div>
		<div class="flex flex-col justify-center items-center min-w-[100px]">
			<button
				...
				data-text="디"
				on:click={play_element_value_by_slow}>디</button
			>
			<button
